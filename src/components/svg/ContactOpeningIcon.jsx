...
const ContactOpeningIcon = ({ width = 20, height = 20, className = "" }) => {
  return (
    <svg
    ...
    >
      <g transform="translate(0 -0.002)">
        <g>
          <defs>
            <rect id="ContactOpeningSVGID_1_" y={0} width="22.9" height={23} />
          </defs>
          <clipPath id="ContactOpeningSVGID_2_">
            <use xlinkHref="#ContactOpeningSVGID_1_" style={{ overflow: "visible" }} />
          </clipPath>
          <g transform="translate(0 0.002)" style={{ clipPath: "url(#ContactOpeningSVGID_2_)" }}>
            <path
              className="st1"
...
export default ContactOpeningIcon;
