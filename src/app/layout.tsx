...
export default function RootLayout({
  ...
  return (
    <html lang="en" suppressHydrationWarning={isDev}>
      <head>
        <meta name="keywords" content="Flyingzone - Tour & Travel Booking React Next js Template" />
        <meta name="description" content="Flyingzone is a Modern Tour & Travel Booking React Next js Template. It is perfect for travel businesses of all kinds. Flyingzone boasts a unique and intuitive search function that is ideal for tour operators, adventure companies, and holiday booking websites alike, as well as hotel booking, plane ticket booking, car rental, and property rental. It's easy and quick to launch a professional and cost-effective travel website." />
