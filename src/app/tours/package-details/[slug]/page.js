...
const TourDetailPage = () => {
  ...
  const packageItem = toursData.tours.find((pkg) => pkg.slug === slug);
  ...
  const description = packageItem.description || `Experience an amazing journey with our ${packageItem.title}. This comprehensive tour package includes comfortable flights, quality hotel accommodations, and all necessary arrangements for a memorable travel experience.`;
  const itinerary = packageItem.itinerary || [
    { day: "Day 1", title: "Arrival", description: "Arrive at destination and check-in at hotel." },
    { day: "Day 2-6", title: "Tour Activities", description: "Explore destinations and enjoy various activities." },
  ...
  return (
    <>
      <Topbar />
      <Header />
      <Breadcrumb pagename={packageItem.title} pagetitle="Tour Package Details" />
                  ...
                  <div className="accordion" id="accordionTravel">
                    <div className="accordion-item">
                      <h2 className="accordion-header" id="travelheadingOne">
                        ...
                        >
                          01. How do I book a tour package?
                        </button>
                      </h2>
                      <div
                      ...
                      >
                        <div className="accordion-body">
                          You can book a tour package by filling out the booking form on this page or contacting our customer service team directly.
                        </div>
                      </div>
                    </div>
                    <div className="accordion-item">
                      <h2 className="accordion-header" id="travelheadingTwo">
                        ...
                        >
                          02. What documents are required for travel?
                        </button>
                      </h2>
                      <div
                      ...
                      >
                        <div className="accordion-body">
                          You will need a valid passport and other travel documents. Our team will assist you with visa processing if required.
                        </div>
                      </div>
                    </div>
                    <div className="accordion-item">
                      ...
                      >
                        <div className="accordion-body">
                          The package includes return airfare, hotel accommodation, ground transportation, entrance fees to attractions, meals (as specified), and professional guide services.
                        </div>
                      </div>
                    </div>
                    <div className="accordion-item">
                      <h2 className="accordion-header" id="travelheadingFour">
                        ...
                        >
                          04. Can I customize my tour package?
                        </button>
                      </h2>
                      <div
