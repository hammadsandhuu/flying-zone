...
const UmrahDetailPage = () => {
  ...
  const packageItem = umrahData.umrahByBus.find((pkg) => pkg.slug === slug);
  ...
  const description = packageItem.description || `Experience a spiritual journey with our ${packageItem.title}. This comprehensive package includes comfortable bus travel, quality hotel accommodations, and all necessary arrangements for a memorable Umrah pilgrimage.`;
  const itinerary = packageItem.itinerary || [
    { day: "Day 1", title: "Departure", description: "Depart by bus and begin the journey to Saudi Arabia." },
    { day: "Day 2-6", title: "Mecca - Umrah Performance", description: "Arrive in Mecca, perform Umrah rituals, and visit the Grand Mosque." },
    { day: "Day 7-10", title: "Medina Visit", description: "Travel to Medina, visit the Prophet's Mosque and historical sites." },
    { day: "Day 11", title: "Return Journey", description: "Begin return journey by bus." }
  ];
                ...
                <div className="faq-content">
                  <div className="accordion" id="accordionTravel">
                    ...
                    <div className="accordion-item">
                      ...
                      >
                        <div className="accordion-body">
                          The package includes comfortable bus transportation, hotel accommodation, ground transportation, visa assistance, meals, and professional guide services.
                        </div>
                      </div>
                    </div>
                    <div className="accordion-item">
